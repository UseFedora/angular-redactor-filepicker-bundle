  ...
  return {
    ...
    show: function () {
      filepicker.pick({
        mimetype: 'image/*',
        container: 'modal',
        services: ["COMPUTER", "CUSTOMSOURCE", "DROPBOX", "FTP", "GOOGLE_DRIVE", "IMAGE_SEARCH", "SKYDRIVE", "URL"]
      }, {
        location: "S3"
      });
    },
...
const plugins = ['fontcolor', 'fontfamily', 'filepicker', 'fullscreen', 'fontsize', 'limiter'];
